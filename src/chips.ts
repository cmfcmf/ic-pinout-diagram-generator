import { chips as other } from "./chips/other";
import { chips as padauk } from "./chips/padauk";
...
export default [...other, ...padauk, ...wch, ...propeller, ...propeller1, ...raspberrypi, ...stm32g0];
